...
const Home = () => {
  ...
  const images = [
    'https://huangrx.cn/img/about-rose.jpg',
    'https://huangrx.cn/img/youandme.jpg',
  ...
  const onMenuChange = (param: number) => {
    Taro.navigateTo({
      url: param === 1 ? "/subPages/pages/food/index" : param === 2 ? "/subPages/pages/memorial/index" : "/subPages/pages/loveletter/index"
    })
  }
      ...
      <View className="home_body">
        ...
        <View className="home_menu_items">
          <View className="home_menu_item" onClick={() => onMenuChange(1)}>
            ...
            <Text className="home_menu_text">喂饱你</Text>
          </View>
